                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo $err_day;  ?></td>
                            ...
                            <td><span><?php echo $err_month;  ?></span><br /></td>
                            </td>
                            <td>
                            <select name="year">
                            ...
                            <td><span><?php echo $err_year;  ?></span><br /></td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="submit"name="btn_SignIn" value="Register "  /><br><br><br>    Already have an account?<a href="MemberLogin.php">Log in</a>
                        </td>
                        <td><span><?php echo $err_db;?></span></td>
                    </tr>
                </table>
            </form>
        </fieldset>
